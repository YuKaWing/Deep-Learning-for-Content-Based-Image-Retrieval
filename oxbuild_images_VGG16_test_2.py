...
TRAINED_HEAD_MODEL_PATH=os.path.sep.join([config.OUTPUT_PATH, "VGG16_oxbuild_images_trained_head.hdf5"])
MODEL_PATH=os.path.sep.join([config.OUTPUT_PATH, "VGG16_oxbuild_images.hdf5"])
