...
TRAINED_HEAD_MODEL_PATH=os.path.sep.join([config.OUTPUT_PATH, "VGG16_256_ObjectCategories_trained_head.hdf5"])
MODEL_PATH=os.path.sep.join([config.OUTPUT_PATH, "VGG16_256_ObjectCategories.hdf5"])
