...
modelPath = os.path.sep.join([config1.OUTPUT_PATH, "ResNet50_INRIA_Holidays.hdf5"])
...
for (i_pbar, query) in enumerate(queries):
    ...
    searcher = Searcher(os.path.sep.join([config.HDF5_PATH, "features_INRIA_Holidays_ResNet50.hdf5"]))
