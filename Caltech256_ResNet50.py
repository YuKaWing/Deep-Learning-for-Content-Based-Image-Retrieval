...
MODEL_PATH=os.path.sep.join([config.OUTPUT_PATH, "ResNet50_256_ObjectCategories"])
TRAINED_HEAD_MODEL_PATH=os.path.sep.join([config.OUTPUT_PATH, "ResNet50_256_ObjectCategories_trained_head"])
...
path = os.path.sep.join([config.OUTPUT_PATH, "ResNet50_256_ObjectCategories_train_head.png"])
