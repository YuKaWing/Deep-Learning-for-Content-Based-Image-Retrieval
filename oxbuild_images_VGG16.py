...
MODEL_PATH="datasets/oxbuild_images/output/VGG16_oxbuild_images"
TRAINED_HEAD_MODEL_PATH="datasets/oxbuild_images/output/VGG16_oxbuild_images_trained_head"
